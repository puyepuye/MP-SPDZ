...
enum
{
    ...
    OTLS_TCP_CONNECT = 0x1C3,
    OTLS_TCP_CLOSE = 0x1C4,
    OTLS_TCP_BCAST_SEND = 0x1C5,
    OTLS_TCP_BCAST_RECV = 0x1C6,
    OTLS_TLS_CLIENTHELLO_POC = 0x1C7,
    OTLS_TCP_BCAST_RECV_TLS_RECORD = 0x1C8,
    OTLS_TLS_EXPORT_META_POC = 0x1C9,
    OTLS_TLS_WRITE_SCALAR_INPUT_POC = 0x1CA,
    OTLS_TCP_SEND_RECORD_BE = 0x1CB,
    OTLS_TCP_BCAST_WAIT_READABLE = 0x1CC,
    OTLS_TLS_FEED_HS_PLAIN_POC = 0x1CD,
    OTLS_TLS_FINALIZE_TH_SF_POC = 0x1CE,
    // IO
    GPRINTMEM = 0x1B0,
    GPRINTREG = 0X1B1,
